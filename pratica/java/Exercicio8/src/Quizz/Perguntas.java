...
public class Perguntas{
	...
	{
	perguntas[0] = "Qual é o significado da sigla POO?";
	perguntas[1] = "O que siginifica 'int'?";
	perguntas[2] = "Qual palavra é utilizada para instanciar uma classe?";
	perguntas[3] = "Quantos bits tem 1 byte?";
	perguntas[4] = "Qual é a sigla para 'Java virtual machine'?";
	perguntas[5] = "Quantos bytes tem um 'char'?";
	perguntas[6] = "Quem é considerado como o 'pai' do Java?";
	perguntas[7] = "Qual é o 'simbolo' da linguagem java?";
	perguntas[8] = "Em relação a linguagem Java, a palavra 'Eclipse' se refere a:";
